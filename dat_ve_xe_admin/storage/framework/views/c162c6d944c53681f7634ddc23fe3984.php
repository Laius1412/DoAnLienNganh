...
<html lang="en" class="h-100">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets\vendor\icon-set\style.css')); ?>">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 d-flex justify-content-center align-items-center min-vh-lg-100">
            <div class="w-100 pt-10 pt-lg-7 pb-7" style="max-width: 25rem;">
              <!-- Form -->
              <form class="js-validate" method="POST" action="<?php echo e(route('login.submit')); ?>">
                <?php echo csrf_field(); ?>
                <div class="text-center mb-5">
                ...
                <div class="js-form-message form-group">
                    ...
                    <input type="email" class="form-control form-control-lg" name="email" placeholder="Markwilliams@example.com" aria-label="Markwilliams@example.com" required data-msg="Please enter a valid email address.">
                </div>
...
</html><?php /**PATH E:\GitHub\DoAnLienNganh\dat_ve_xe_admin\resources\views/auth/login.blade.php ENDPATH**/ ?>